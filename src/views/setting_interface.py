...
from ..config.config import cfg, HELP_URL, FEEDBACK_URL, VERSION, YEAR, isWin11
...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.micaCard = SwitchSettingCard(
            FIF.TRANSPARENT,
            self.tr('Mica effect'),
            self.tr('Apply semi transparent to windoSettingCardGroupws and surfaces (if OS Windows)'),
            cfg.micaEnabled,
            self.personalGroup
        )
